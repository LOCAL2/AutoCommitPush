...
export const NameEffect: React.FC<NameEffectProps> = ({
  ...
  const effectClasses: Record<string, string> = {
    ...
    // Extended Gaming & Esports (20)
    overcharge_rgb: "bg-gradient-to-r from-red-500 via-green-400 via-blue-500 to-yellow-400 bg-clip-text text-transparent animate-rainbow-flow font-bold drop-shadow-[0_0_12px_rgba(59,130,246,1)]",
    shadow_demon: "bg-gradient-to-r from-red-500 via-rose-400 to-purple-400 bg-clip-text text-transparent font-bold drop-shadow-[0_0_10px_rgba(225,29,72,0.95)]",
    valkyrie_gold: "bg-gradient-to-r from-amber-200 via-yellow-400 to-amber-500 bg-clip-text text-transparent font-bold animate-pulse drop-shadow-[0_0_10px_rgba(251,191,36,0.95)]",
    arcane_magic: "bg-gradient-to-r from-purple-400 via-fuchsia-300 to-indigo-400 bg-clip-text text-transparent font-bold animate-rainbow-flow drop-shadow-[0_0_10px_rgba(168,85,247,0.95)]",
    abyssal_void: "bg-gradient-to-r from-violet-400 via-purple-300 to-indigo-400 bg-clip-text text-transparent font-bold drop-shadow-[0_0_10px_rgba(139,92,246,0.95)]",
    hyper_beam: "bg-gradient-to-r from-red-500 via-rose-400 to-orange-400 bg-clip-text text-transparent font-bold animate-pulse drop-shadow-[0_0_12px_rgba(239,68,68,1)]",
    phoenix_rebirth: "bg-gradient-to-r from-orange-400 via-amber-300 to-yellow-300 bg-clip-text text-transparent font-bold animate-rainbow-flow drop-shadow-[0_0_10px_rgba(245,158,11,0.95)]",
    frostbite_blue: "bg-gradient-to-r from-cyan-300 via-sky-200 to-blue-400 bg-clip-text text-transparent font-bold drop-shadow-[0_0_10px_rgba(56,189,248,0.95)]",
    venom_strike: "bg-gradient-to-r from-lime-400 via-emerald-300 to-green-400 bg-clip-text text-transparent font-bold animate-pulse drop-shadow-[0_0_10px_rgba(163,230,53,0.95)]",
    titanium_shield: "bg-gradient-to-r from-slate-200 via-white to-zinc-300 bg-clip-text text-transparent font-bold drop-shadow-[0_0_9px_rgba(203,213,225,0.9)]",
    solar_god: "bg-gradient-to-r from-yellow-300 via-amber-300 to-orange-400 bg-clip-text text-transparent font-bold animate-pulse drop-shadow-[0_0_12px_rgba(250,204,21,1)]",
    starlight_glimmer: "bg-gradient-to-r from-amber-200 via-sky-200 to-purple-200 bg-clip-text text-transparent font-semibold drop-shadow-[0_0_9px_rgba(253,230,138,0.9)]",
    vampire_blood: "bg-gradient-to-r from-rose-500 via-red-400 to-rose-600 bg-clip-text text-transparent font-bold drop-shadow-[0_0_10px_rgba(225,29,72,0.95)]",
    cyber_punk_neon: "bg-gradient-to-r from-pink-400 via-purple-300 to-cyan-300 bg-clip-text text-transparent font-bold animate-rainbow-flow drop-shadow-[0_0_10px_rgba(236,72,153,0.95)]",
    supernova_glow: "bg-gradient-to-r from-sky-300 via-indigo-200 to-cyan-300 bg-clip-text text-transparent font-bold animate-pulse drop-shadow-[0_0_12px_rgba(56,189,248,1)]",
    quantum_pulse: "bg-gradient-to-r from-cyan-300 via-sky-200 to-teal-300 bg-clip-text text-transparent font-semibold drop-shadow-[0_0_9px_rgba(34,211,238,0.9)]",
    celestial_empress: "bg-gradient-to-r from-amber-200 via-purple-300 to-pink-300 bg-clip-text text-transparent font-bold animate-rainbow-flow drop-shadow-[0_0_10px_rgba(244,114,182,0.95)]",
    golden_pharaoh: "bg-gradient-to-r from-yellow-300 via-amber-300 to-yellow-500 bg-clip-text text-transparent font-bold drop-shadow-[0_0_10px_rgba(234,179,8,0.95)]",
    stealth_ninja: "bg-gradient-to-r from-slate-200 via-cyan-200 to-slate-400 bg-clip-text text-transparent font-bold drop-shadow-[0_0_8px_rgba(161,161,170,0.9)]",
    inferno_core: "bg-gradient-to-r from-red-500 via-orange-400 to-yellow-300 bg-clip-text text-transparent font-bold animate-pulse drop-shadow-[0_0_12px_rgba(239,68,68,1)]",

    // Extended Luxury & Royalty (20)
    diamond_sparkle: "bg-gradient-to-r from-slate-100 via-cyan-100 to-white bg-clip-text text-transparent font-bold animate-pulse drop-shadow-[0_0_11px_rgba(255,255,255,1)]",
    rose_gold_luxe: "bg-gradient-to-r from-rose-300 via-pink-200 to-rose-400 bg-clip-text text-transparent font-bold drop-shadow-[0_0_9px_rgba(244,114,182,0.9)]",
    platinum_shine: "bg-gradient-to-r from-zinc-100 via-slate-100 to-zinc-200 bg-clip-text text-transparent font-bold drop-shadow-[0_0_9px_rgba(228,228,231,0.95)]",
    sapphire_glow: "bg-gradient-to-r from-blue-400 via-sky-300 to-indigo-300 bg-clip-text text-transparent font-bold animate-rainbow-flow drop-shadow-[0_0_10px_rgba(59,130,246,0.95)]",
    emerald_king: "bg-gradient-to-r from-emerald-400 via-green-300 to-teal-300 bg-clip-text text-transparent font-bold drop-shadow-[0_0_10px_rgba(16,185,129,0.95)]",
    black_diamond: "bg-gradient-to-r from-amber-300 via-slate-200 to-amber-400 bg-clip-text text-transparent font-bold drop-shadow-[0_0_9px_rgba(251,191,36,0.9)]",
    champagne_bubble: "bg-gradient-to-r from-amber-200 via-yellow-100 to-amber-300 bg-clip-text text-transparent font-bold animate-pulse drop-shadow-[0_0_9px_rgba(252,211,77,0.9)]",
    imperial_jade: "bg-gradient-to-r from-emerald-400 via-teal-300 to-green-200 bg-clip-text text-transparent font-bold drop-shadow-[0_0_10px_rgba(52,211,153,0.95)]",
    regal_purple: "bg-gradient-to-r from-purple-400 via-violet-300 to-fuchsia-400 bg-clip-text text-transparent font-bold drop-shadow-[0_0_10px_rgba(168,85,247,0.95)]",
    golden_crown: "bg-gradient-to-r from-yellow-300 via-amber-300 to-yellow-500 bg-clip-text text-transparent font-bold animate-rainbow-flow drop-shadow-[0_0_10px_rgba(234,179,8,0.95)]",
    pearl_shimmer_text: "bg-gradient-to-r from-rose-100 via-white to-sky-100 bg-clip-text text-transparent font-semibold drop-shadow-[0_0_8px_rgba(255,255,255,0.9)]",
    ruby_sovereign: "bg-gradient-to-r from-rose-500 via-red-400 to-pink-500 bg-clip-text text-transparent font-bold drop-shadow-[0_0_10px_rgba(225,29,72,0.95)]",
    opal_fire: "bg-gradient-to-r from-pink-300 via-cyan-200 to-amber-200 bg-clip-text text-transparent font-semibold animate-rainbow-flow drop-shadow-[0_0_9px_rgba(244,114,182,0.9)]",
    obsidian_gold: "bg-gradient-to-r from-amber-300 via-slate-100 to-yellow-400 bg-clip-text text-transparent font-bold drop-shadow-[0_0_9px_rgba(251,191,36,0.9)]",
    crystal_halo: "bg-gradient-to-r from-sky-200 via-cyan-100 to-indigo-200 bg-clip-text text-transparent font-bold drop-shadow-[0_0_9px_rgba(186,230,253,0.95)]",
    velvet_night: "bg-gradient-to-r from-purple-400 via-violet-300 to-amber-300 bg-clip-text text-transparent font-bold drop-shadow-[0_0_9px_rgba(147,51,234,0.9)]",
    monarch_gold: "bg-gradient-to-r from-amber-300 via-yellow-200 to-amber-500 bg-clip-text text-transparent font-bold animate-pulse drop-shadow-[0_0_12px_rgba(245,158,11,1)]",
    gilded_glory: "bg-gradient-to-r from-yellow-400 via-amber-200 to-yellow-500 bg-clip-text text-transparent font-bold drop-shadow-[0_0_10px_rgba(234,179,8,0.95)]",
    luxe_platinum: "bg-gradient-to-r from-slate-100 via-white to-zinc-200 bg-clip-text text-transparent font-bold drop-shadow-[0_0_9px_rgba(255,255,255,0.95)]",
    royal_amethyst: "bg-gradient-to-r from-purple-400 via-violet-300 to-fuchsia-400 bg-clip-text text-transparent font-bold drop-shadow-[0_0_10px_rgba(192,132,252,0.95)]",

    // Extended Sci-Fi & Cyberpunk (20)
    holo_scan: "bg-gradient-to-r from-cyan-300 via-sky-200 to-blue-400 bg-clip-text text-transparent font-mono animate-pulse drop-shadow-[0_0_10px_rgba(34,211,238,0.95)]",
    tron_orange: "bg-gradient-to-r from-orange-400 via-amber-300 to-yellow-300 bg-clip-text text-transparent font-mono font-bold drop-shadow-[0_0_10px_rgba(249,115,22,0.95)]",
    laser_violet: "bg-gradient-to-r from-fuchsia-400 via-purple-300 to-indigo-400 bg-clip-text text-transparent font-bold animate-pulse drop-shadow-[0_0_12px_rgba(217,70,239,1)]",
    grid_matrix: "bg-gradient-to-r from-emerald-300 via-green-200 to-teal-300 bg-clip-text text-transparent font-mono font-bold drop-shadow-[0_0_10px_rgba(52,211,153,0.95)]",
    warp_speed: "bg-gradient-to-r from-blue-400 via-cyan-300 to-purple-400 bg-clip-text text-transparent font-bold animate-rainbow-flow drop-shadow-[0_0_10px_rgba(59,130,246,0.95)]",
    reactor_pulse: "bg-gradient-to-r from-purple-400 via-fuchsia-300 to-cyan-300 bg-clip-text text-transparent font-bold animate-pulse drop-shadow-[0_0_10px_rgba(192,132,252,0.95)]",
    plasma_cyan: "bg-gradient-to-r from-cyan-300 via-teal-200 to-sky-300 bg-clip-text text-transparent font-bold drop-shadow-[0_0_10px_rgba(45,212,191,0.95)]",
    cyber_lime_glow: "bg-gradient-to-r from-lime-300 via-emerald-200 to-green-400 bg-clip-text text-transparent font-mono font-bold drop-shadow-[0_0_10px_rgba(163,230,53,0.95)]",
    synth_purple: "bg-gradient-to-r from-fuchsia-400 via-purple-300 to-pink-400 bg-clip-text text-transparent font-bold animate-rainbow-flow drop-shadow-[0_0_10px_rgba(217,70,239,0.95)]",
    orbital_beam: "bg-gradient-to-r from-sky-300 via-blue-300 to-indigo-400 bg-clip-text text-transparent font-bold drop-shadow-[0_0_10px_rgba(56,189,248,0.95)]",
    quantum_flux: "bg-gradient-to-r from-teal-200 via-cyan-300 to-blue-400 bg-clip-text text-transparent font-bold animate-pulse drop-shadow-[0_0_10px_rgba(45,212,191,0.95)]",
    tachyon_wave: "bg-gradient-to-r from-indigo-300 via-purple-300 to-pink-300 bg-clip-text text-transparent font-bold animate-rainbow-flow drop-shadow-[0_0_10px_rgba(129,140,248,0.95)]",
    singularity_black: "bg-gradient-to-r from-purple-400 via-indigo-300 to-cyan-300 bg-clip-text text-transparent font-bold drop-shadow-[0_0_9px_rgba(147,51,234,0.9)]",
    neon_pulse: "bg-gradient-to-r from-pink-400 via-cyan-300 to-yellow-200 bg-clip-text text-transparent font-mono font-bold animate-pulse drop-shadow-[0_0_12px_rgba(236,72,153,1)]",
    binary_green: "bg-gradient-to-r from-emerald-400 via-green-300 to-lime-200 bg-clip-text text-transparent font-mono font-bold drop-shadow-[0_0_10px_rgba(16,185,129,0.95)]",
    starburst_rgb: "bg-gradient-to-r from-red-400 via-yellow-300 via-green-300 to-blue-400 bg-clip-text text-transparent font-bold animate-rainbow-flow drop-shadow-[0_0_12px_rgba(239,68,68,1)]",
    hologram_blue: "bg-gradient-to-r from-sky-200 via-cyan-100 to-blue-300 bg-clip-text text-transparent font-mono drop-shadow-[0_0_9px_rgba(186,230,253,0.95)]",
    dark_matter: "bg-gradient-to-r from-indigo-300 via-purple-300 to-pink-300 bg-clip-text text-transparent font-bold drop-shadow-[0_0_9px_rgba(99,102,241,0.9)]",
    space_odyssey: "bg-gradient-to-r from-blue-400 via-purple-300 to-pink-300 bg-clip-text text-transparent font-bold animate-rainbow-flow drop-shadow-[0_0_10px_rgba(168,85,247,0.95)]",
    interstellar_glow: "bg-gradient-to-r from-indigo-200 via-purple-200 to-rose-200 bg-clip-text text-transparent font-bold drop-shadow-[0_0_9px_rgba(165,180,252,0.9)]",
